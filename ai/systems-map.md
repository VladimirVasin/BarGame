...
| Cannery and fish deliveries | Reserved truck trips feed one factory batch and shop handoff; empty-tare return remains deferred. | `CityCannery*`, `CityFishSupply{Cycle,Session}` | Partial |
