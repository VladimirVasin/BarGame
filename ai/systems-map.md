...
| Eastern mainland view | Closed post, distant road/skyline, terrain-fitted surroundings; same camera/fog/lights. | `CityEastExit{Plan,Planner,WorldBuilder,DressingPlan,DressingWorldBuilder}`, `CityEastDistanceWorldBuilder` | Current |
