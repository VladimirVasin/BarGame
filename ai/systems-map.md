...
| City Blender misc catalog | CityMisc `4.9.0`: `82` kinds / `122` assemblies / `259` passive role meshes / `46,546` triangles; plans retain placement, collision and dynamics. | `CityMiscAssetProvider{,.LateCatalog}`, `CityMiscAssetSetup` | Current |
