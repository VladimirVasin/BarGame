...
| Wearable scarf | Equipped cloth meets real hero/NPC/world model surfaces; mouth access, visibility and mirror share the corrected geometry. | `PlayerScarf*`, `PlayerFactory` | Current |
