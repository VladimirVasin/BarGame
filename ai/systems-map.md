...
| Intoxication effects | Show the HUD only after intoxication rises above zero; apply timed movement slowdown and sprite sway | `IntoxicationStatusController.cs`, `IntoxicationHudView.cs` | Implemented |
