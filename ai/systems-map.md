...
| Combat test | Rig contacts: six zones/local directions, rear-head defeat; guard/parry, AI, inertia, blood; R resets. | `CombatTestRoot`, `Runtime/Combat`, `Rules/Combat` | Current |
