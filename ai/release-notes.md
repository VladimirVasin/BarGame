...
- **Копка.** Яма поделена на шесть участков, каждый в три слоя. Удерживаешь
  `E` — лопата ходит вверх-вниз в замахе; отпустил в нужный момент — снял
  слой, промахнулся — черенок отдаёт в руки. Земля под каждым слоем своя:
  дёрн прощает почти всё, суглинок чуть меньше, глина строже, а камень и
  корень требуют по-настоящему точного момента. Слой везде снимается с
  одного удара: бить дважды по одной клетке больше не нужно, это только
  растягивало работу. Что где лежит — каждый раз новое:
  бросил копку и начал заново, и земля под лопатой другая. Копать вглубь
  одну ямку нельзя: участок не даст себя углубить, пока соседний отстаёт
  на слой. Так и копают — заходами, по всей яме.
...
- **Засыпка.** Та же лопата, та же решётка, только слои возвращаются снизу
  вверх, а куча грунта рядом убывает на глазах.
