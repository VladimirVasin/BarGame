...
- **Камень.** Свежая земля не держит: памятник кренится. `A`/`D` подпираешь
  плечом, `E` трамбуешь — но трамбовать кривой камень значит загонять
  нижний край ещё глубже, так что сперва отвес, потом нога.
