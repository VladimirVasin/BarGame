...
### 2026-08-24 — Кадры как на приставке, и лестница больше не липнет

- Игра теперь идёт в 30 кадров — в том самом темпе, в котором работали
  Silent Hill на PS1 и Silent Hill 2 на PS2. В настройках паузы появился
  пункт «60 КАДРОВ (ВМЕСТО 30)» для тех, кому нужнее плавность; выбор
  сохраняется и применяется сразу, без перезапуска.
