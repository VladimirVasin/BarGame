...
### 2026-08-24 — Автобус сначала слышно, потом видно

- Дизель автобуса теперь доносится из заднего моторного отсека через туман ещё
  до появления машины в кадре. По мере приближения он становится плотнее, но
  не превращается в рассеянный городской гул.
