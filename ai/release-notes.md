...
- Гора над водяной пещерой снова цельная: корона устья была ниже
  соседнего пика на 4 метра открытого неба, а гребень скалы, если
  стоять у самого устья, растворялся в тумане на полувысоте — полоса
  передачи силуэта дальнему куполу начиналась слишком близко. Заодно
  убрано мерцание текстуры у арки (z-конфликт нахлёста короны и
  боковых плит).
