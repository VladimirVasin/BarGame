...
2. Observe a compact connected road network, decorative buildings, and multiple visually identifiable bars.
3. Move with `WASD`/arrows while remaining on walkable road space.
4. Approach a bar entrance and see an interaction prompt.
