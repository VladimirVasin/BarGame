# Release notes archive — 2026-07

July 2026 player-visible notes, reverse chronological, retained verbatim
from `ai/release-notes.md`. Archived under the retention rule in
`ai/README.md`. Active notes: [`ai/release-notes.md`](../release-notes.md).
