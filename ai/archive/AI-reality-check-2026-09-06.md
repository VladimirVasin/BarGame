# Superseded AI entry-point narrative

Archived verbatim on 2026-09-06 when the entry point was shortened. This is a
historical snapshot, not the current specification. Use [project overview](../project-overview.md)
and [current world](../current-world.md); later facts supersede this narrative.
