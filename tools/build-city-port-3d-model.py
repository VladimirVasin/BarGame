...
def dock(mat):
    ...
    g.role="SteelLight"
    chamfer(g,(4.06,2.98,-14),(.08,2.95,2.9),CABIN,.025)
    for y in (1.9,2.4,2.9,3.4,3.9):g.box((4.112,y,-14),(.025,.025,2.83),METAL)
    g.role=None
...
def main():
    ...
    if args.validate_only:
        ...
        for r in roots:base.export(r,args.model_dir/(r.name+".fbx"))
