...
namespace BarPromenade.Tests.EditMode
{
    ...
    public sealed class CityMiscAssetTests
    {
        ...
        [Test]
        public void Catalog_DeclaresExactNinetyOneAssemblyOneSeventySevenMeshWave()
        {
            Assert.That(
                CityMiscAssetProvider.DesignId,
                Is.EqualTo("city_misc_citywide_v3"));
            Assert.That(
            ...
            Assert.That(
                ...
                Is.EqualTo(177));
            Assert.That(ExpectedParts, Has.Length.EqualTo(177));
            ...
            Assert.That(assemblies, Is.EqualTo(91));
            Assert.That(
                actualNames,
        ...
        public void ImportedKit_ValidatesAsPassiveFixedMeterGeometry()
        {
            ...
            Assert.That(manifest.mesh_count, Is.EqualTo(177));
            Assert.That(manifest.assembly_count, Is.EqualTo(91));
            ...
            Assert.That(meshes, Has.Length.EqualTo(177));
        ...
        public void Provider_CarriesEveryExactMeshAndCurrentSignature()
        {
            ...
            Assert.That(actualNames, Has.Count.EqualTo(177));
            UnityEngine.Object[] imported =
