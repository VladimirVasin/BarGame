...
{
    /// <summary>
    /// Owns the cold exterior grade and the one real practical at the tunnel
    /// exit. The practical's light, its visible fixture and its positional
    /// ballast source all share the same plan anchor.
    /// </summary>
