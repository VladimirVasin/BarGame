    ...
    public static class Player3DV2AssetSetup
    {
        ...
        private static readonly IReadOnlyDictionary<string, ActionContract>
            ...
            new Dictionary<string, ActionContract>(StringComparer.Ordinal)
            {
                ...
                { "RiseSeatedLeft", new ActionContract("fall", false) },
                { "RiseSeatedRight", new ActionContract("fall", false) },
                { "RiseSeatedToCrawlLeft", new ActionContract("fall", false) },
                { "RiseSeatedToCrawlRight", new ActionContract("fall", false) },
