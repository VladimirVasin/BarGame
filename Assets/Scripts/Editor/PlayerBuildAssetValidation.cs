...
namespace BarPromenade.Editor
{
    ...
    public sealed class PlayerBuildAssetValidation : IPreprocessBuildWithReport
    {
        ...
        static PlayerBuildAssetValidation()
        {
            ...
            RegisterGenerated("Default NPC", DefaultNpcAssetSetup.ValidateOrThrow, "DefaultNpcAssetSetup");
            ...
            RegisterGenerated("Village expansion", VillageExpansionAssetSetup.ValidateOrThrow, "VillageExpansionAssetSetup");
            RegisterGenerated("Village narrative", VillageNarrativeAssetSetup.ValidateOrThrow, "VillageNarrativeAssetSetup");
